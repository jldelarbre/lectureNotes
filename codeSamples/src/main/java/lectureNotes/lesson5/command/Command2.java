    ...
    static class MaintenanceScheduler {
        ...
        void scheduleMaintenance() {
            ...
            for (MaintainableEquipment maintainableEquipment : equipmentMaintenanceMap.keySet()) {
                ...
                // It is a brick of execution which could be manipulate to serve many purpose:
                // here multi threaded execution
                Executors.newSingleThreadExecutor().execute(() -> maintenanceProcess.execute());
            }
        }
    }
}
